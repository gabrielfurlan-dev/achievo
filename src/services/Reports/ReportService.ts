...
export async function CreateReport({ userRef, progressGoals, checkGoals }: ICreateReport) {
    try {
        ...
        return { success: false, message: "Erro ao adicionar o relatório.", data: null } as IResponseData;
    }
}
...
export async function updateReport({ reportId, progressGoals, checkGoals }: IUpdateReport) {
    try {
        ...
        return { success: true, message: "Relatório atualizado com sucesso.", data: report } as IResponseData;

    } catch (error) {
        return { success: false, message: "Erro ao atualizar o relatório.", data: null } as IResponseData;
    }
}
...
export async function getAllReports() {
    try {
        ...
        return { success: true, message: "Relatórios obtidos com sucesso.", data: data.data } as IResponseData;

    } catch (error) {
        return { success: false, message: "Erro ao obter os relatórios.", data: null } as IResponseData;
    }
}
...
export async function getReport(reportId: number) {
    try {
        ...
        const report = await fetch(api.concat('/api/report/get?reportId=' + reportId), {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        })
        ...
        return { success: true, message: "Relatório obtido com sucesso.", data: data.data } as IResponseData;

    } catch (error) {
        return { success: false, message: "Erro ao obter o relatório.", data: null } as IResponseData;
    }
}
